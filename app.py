...
#C:\Users\hp\Downloads\bootcamp_tf_idf-main\bootcamp_tf_idf-main\Leetcode-Questions-Scrapper-master\lc_problems.txt
def load_link_of_qs():
    with open("Leetcode-Questions-Scrapper-master/lc_problems.txt", "r",encoding='utf-8') as f:
        links = f.readlines()
